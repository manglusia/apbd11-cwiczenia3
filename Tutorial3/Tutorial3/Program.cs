...
Container liquidContainer = new LiquidContainer(10.0,6.0, 4.0, 20.0, 3.0,true);
LiquidContainer liquidContainer2 = new LiquidContainer(10.0,6.0, 4.0, 20.0, 3.0, false);
container.Load(10);
